...
test = os.listdir("/ASR_Kmeans/QUAM/MNIST/x_test")
...
# id_o = [39,220,292,330,347,390,449,484,519,599,611,702,735,741,765,768,775,800, 806,841,845,994,998]
...
for i in range(len(test)):
    x_test[i] = np.mean(
        cv.imread("/ASR_Kmeans/QUAM/MNIST/x_test/" + str(test[i])), axis=2
    )
...
with open("/ASR_Kmeans/QUAM/entropies_ID_c.txt", "w+") as f:
